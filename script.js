$(document).ready(function(){
  ...
  $("#call-api").click(function(){
    ...
    // call the API
    var url = "https://api.nasa.gov/planetary/apod?api_key=B8UNxTRKr7FDWLcVDCYgJTpbr1Lpg6FnkpqGT2qE&date=2002-03-26&hd=false"; // add your API's URL here!
    $.get(url, function(data, status){
        console.log("Data: " + data + "\nStatus: " + status);
        console.log(data);
        $("img").attr("scr", data.url);
